...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <input type="text" name="pay_code" id="pay_code" class="form-control" value="<?php echo $row['pay_code'] ?>" required>
    </div>
    <div class="col-md-6">
...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <input type="date" name="doj" id="doj" class="form-control" value="<?php echo $row['doj']->format('Y-m-d') ?>" required>
    </div>
    <div class="col-md-6">
        <label for="dob">DOB</label>
        <input type="date" name="dob" id="dob" class="form-control" value="<?php echo $row['dob']->format('Y-m-d') ?>" required>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
